function baseplant(widget_id, url, skin, parameters)
{
    ...
    function set_value(self, state)
    {
        ...
        if (state.attributes['brightness']) {
            self.set_field(self, "brightness", state.attributes['brightness']);
        ...
        if (state.attributes['battery']) {
            self.set_field(self, "battery", state.attributes['battery']);
            self.set_field(self, "battery_unit", units['battery']);
        }

        if (state.attributes['temperature']) {
            self.set_field(self, "temperature", state.attributes['temperature']);
            self.set_field(self, "temperature_unit", '°C');
        }
