function baseiconsensor(widget_id, url, skin, parameters)
{
    ...
    function set_view(self, state, level)
    {
        if (state)
        {
            ...
            self.set_field(self, "state_text", state);
        }
        else
        {
            ...
            if(self.parameters.state_text_inactive && self.parameters.state_text_inactive != "") {
              self.set_field(self, "state_text", self.parameters.state_text_inactive);
            } else {
