function basecryptoportfolio(widget_id, url, skin, parameters)
{
    ...
    self.widget_icons =
    {
      ...
      "train": 'mdi mdi-flower',
      "baseball": 'mdi mdi-alert-circle-outline alert-color'
    };

    var widgetStyleNormal = 'background: linear-gradient(rgba(0, 0, 0, 0.75), rgba(0, 0, 0, 0.75)), url(./custom_css/bithome/img/allergy.jpg); background-size: auto 100%; background-position: center;'
    //var widgetStyleAlert = 'background: linear-gradient(rgba(112,53,0, 0.45), rgba(112,53,0, 0.45)), url(./custom_css/bithome/img/allergy.jpg); background-size: auto 100%; background-position: center; z-index: 0;'
    var widgetStyleAlert = 'background: linear-gradient(rgba(112,53,0, 0.45), rgba(112,53,0, 0.45)), url(./custom_css/bithome/img/allergy.jpg) no-repeat; -webkit-background-size: auto 100%; -moz-background-size: auto 100%; -o-background-size: auto %100; background-size: auto %100; background-position: center;';
    ...
    function set_value(self, state)
    {
        ...
        else
        {
            ...
            self.set_field(self, "value", parseFloat(value/1000).toFixed(2));

            if(value > 5.0) {
              self.set_field(self, "widget_class", "alert");
              //self.set_field(self, "widget_style", widgetStyleAlert);
            } else {
              self.set_field(self, "widget_class", null);
              //self.set_field(self, "widget_style", widgetStyleNormal);
            }
        }
    }
